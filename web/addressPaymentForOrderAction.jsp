...
<%
	...
	PreparedStatement ps1 = conn.prepareStatement("Update cart set address=?,city=?,state=?,country=?,mobileNumber=?,orderDate=SYSDATE,DelieveryDate=SYSDATE+7,paymentMethod=?, transactionId=?,status=? where email=? and address IS NULL");
