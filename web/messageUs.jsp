...
<form action="messageUsAction.jsp" method="post">
    <input type="text" placeholder="Subject" class="input-style" name="subject"/>
        <hr>
    <textarea  placeholder="Enter Your Message" class="input-style" name="body" required></textarea>
    <hr>
